...
public interface WebResourceRoot extends Lifecycle {
    ...
    /**
     * 资源主要有四种:
     * 第一种:pre资源 可以在context.xml添加配置 <PreResource></PreResource>
     * 第二种:main资源  web应用的WEB-INF/目录下的资源lib classes
     * 第三种:Jar资源  配置在<JarResource></JarResource>
     * 第四种:Post 配置在<PostResource></PostResource>
     *
