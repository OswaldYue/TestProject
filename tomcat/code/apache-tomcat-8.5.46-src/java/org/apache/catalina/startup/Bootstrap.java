...
public final class Bootstrap {
    ...
    * */
    ...
    // tomcat定义的三个类加载器 URLClassLoader
    ...
    private void initClassLoaders() {
        try {
            // 这里这所以将加载器父类给null 其目的是要打破类加载时的双亲委派机制
    ...
    private void load(String[] arguments)
        ...
        // 反射的方式去执行org.apache.catalina.startup.Catalina.load(java.lang.String[])方法
        Method method =
   ...
   /**
    ...
    public static void main(String args[]) {
        ...
        // daemon为守护线程 如果为null  说明tomcat还没启动起来  先启动
        if (daemon == null) {
            // 实例化一个Bootstrap并初始化
